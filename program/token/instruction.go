...
const (
	...
	InstructionConfidentialTransferExtension
	InstructionDefaultAccountStateExtension
	InstructionReallocate
	InstructionMemoTransferExtension
	InstructionCreateNativeMint
)
