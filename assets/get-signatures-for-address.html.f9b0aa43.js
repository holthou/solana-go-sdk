import{_ as n,e as s}from"./app.da72e560.js";const a={},t=s(`<h1 id="get-signatures-for-address" tabindex="-1"><a class="header-anchor" href="#get-signatures-for-address" aria-hidden="true">#</a> Get Signatures For Address</h1><p>Fetch tx histroy.</p><h2 id="all" tabindex="-1"><a class="header-anchor" href="#all" aria-hidden="true">#</a> All</h2><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code>	<span class="token comment">// get all (limit is between 1 ~ 1,000, default is 1,000)</span>
