import{_ as n,e as s}from"./app.da72e560.js";const a={},t=s(`<h1 id="accounts" tabindex="-1"><a class="header-anchor" href="#accounts" aria-hidden="true">#</a> Accounts</h1><h3 id="client" tabindex="-1"><a class="header-anchor" href="#client" aria-hidden="true">#</a> client</h3><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token comment">// an account meta list indicates which accounts will be used in a program.</span>
