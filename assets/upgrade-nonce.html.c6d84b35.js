import{_ as t,r as p,o,c as e,a as n,b as c,F as u,d as s,e as l}from"./app.da72e560.js";const i={},r=n("h1",{id:"upgrade-nonce",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#upgrade-nonce","aria-hidden":"true"},"#"),s(" Upgrade Nonce")],-1),k=s("Due to "),b={href:"https://solana.com/news/06-01-22-solana-mainnet-beta-outage-report-2",target:"_blank",rel:"noopener noreferrer"},m=s("2022/06/01 Solana outage"),g=s(". All nonce account should be upgraded. You can update it either"),d=l(`<ol><li>Advance Nonce (need origin authority signature)</li></ol><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
