import{_ as n,e as s}from"./app.da72e560.js";const a={},t=s(`<h1 id="create-mint" tabindex="-1"><a class="header-anchor" href="#create-mint" aria-hidden="true">#</a> Create Mint</h1><p>create a new token</p><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
