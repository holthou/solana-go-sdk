import{_ as n,e as s}from"./app.da72e560.js";const a={},t=s(`<h1 id="get-token-account" tabindex="-1"><a class="header-anchor" href="#get-token-account" aria-hidden="true">#</a> Get Token Account</h1><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
